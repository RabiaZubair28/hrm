...
class EmployeeProfileRequest(models.Model):
    ...
    @api.model
    def _clean_month_value(self, value):
    ...
    def _month_to_employee_date(self, value):
        month_value = self._clean_month_value(value)
        if month_value:
    ...
    def default_get(self, fields_list):
        ...
        res.update({
            ...
            'hrmis_joining_date': self._clean_month_value(employee.hrmis_joining_date),
            ...
            "hrmis_commission_date": self._clean_month_value(employee.hrmis_commission_date),
